                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="location" title="${message(code: 'department.location.label', default: 'Location')}" />
                    ...
                    <g:each in="${departmentInstanceList}" status="i" var="departmentInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: departmentInstance, field: "location")}</td>
