...
<%@ page import="zk.databinding.multibean.Department" %>
<html>
    <head>
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="location"><g:message code="department.location.label" default="Location" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: departmentInstance, field: 'location', 'errors')}">
                                    <g:textField name="location" value="${departmentInstance?.location}" />
                                </td>
                            </tr>
